...
class KGE():
    ...
    def _D_layer(self):
        ...
        D_table = tf.nn.dropout(tf.matmul(_D_table, d_w) + d_b, self.keep)
    ...
    def _em_predict(self, sess):
        ...
        if self.disease == '_cancer' and self.model == 'ConvKB':
    ...
    def _link_prediction(self, sess, T_pos):   
        ...
        Return entity MR, MRR. [ MR (mean rank), MRR (mean reciprocal rank) ]
        ...
        print('{:^8.1f} {:^9.3f}'.format(MR, MRR), end = '')
